...
const approachPrinciples = [
  {
    ...
    description:
      "Every vehicle recovery case involves legal, reputational, and compliance considerations. These are not afterthoughts — they are integral to our methodology. Before any operational action, we assess the complete picture: contractual position, jurisdictional requirements, and potential sensitivities.",
  },
  {
    title: "Why Visibility Is Avoided",
    description:
      "Unnecessary attention creates unnecessary risk. For our clients, this means protecting relationships with customers and partners. For the individuals involved, it means maintaining dignity. Our methods are designed to resolve situations efficiently while preserving discretion for all parties.",
  },
  {
    title: "Outcome Over Exposure",
    description:
      "We measure success by resolution, not by activity. A vehicle recovered quietly and compliantly is more valuable than one recovered visibly. In most cases, our involvement remains known only to the client — and that is precisely the point.",
  },
];
          ...
          >
            <div className="space-y-6">
              {[
                ...
                "Multi-jurisdictional coordination capability",
                "Established local relationships and expertise",
                "Consistent cross-border execution",
