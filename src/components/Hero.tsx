...
export function Hero() {
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="European financial district skyline at dusk" className="w-full h-full object-cover scale-105" />
        ...
        <div className="absolute inset-y-0 left-0 w-[55%]" style={{
